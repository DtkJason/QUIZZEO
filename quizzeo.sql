...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : mar. 13 juin 2023 à 13:40
...
CREATE TABLE IF NOT EXISTS `choix` (
  ...
  `bonneReponse_choix` int NOT NULL,
...
ALTER TABLE `quizz_question`
  ADD CONSTRAINT `quizz_question_ibfk_1` FOREIGN KEY (`id_quizz`) REFERENCES `quizz` (`id_quizz`),
  ADD CONSTRAINT `quizz_question_ibfk_2` FOREIGN KEY (`id_question`) REFERENCES `question` (`id_question`);

--
-- Contraintes pour la table `utilisateur_quizz`
--
ALTER TABLE `utilisateur_quizz`
  ADD CONSTRAINT `utilisateur_quizz_ibfk_1` FOREIGN KEY (`id_utilisateur`) REFERENCES `utilisateur` (`id_utilisateur`),
  ADD CONSTRAINT `utilisateur_quizz_ibfk_2` FOREIGN KEY (`id_quizz`) REFERENCES `quizz` (`id_quizz`);
COMMIT;
